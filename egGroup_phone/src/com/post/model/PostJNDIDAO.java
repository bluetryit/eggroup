...
public class PostJNDIDAO implements PostDAO_interface{
	...
	private static final String GET_IMG_BY_PONO="SELECT POST_IMG FROM POST WHERE POST_NO=?";
...
//			
	...
	@Override
	public byte[] getImage(String post_no) {
		// TODO Auto-generated method stub
		byte[] picture = null;
		Connection con = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(GET_IMG_BY_PONO);
