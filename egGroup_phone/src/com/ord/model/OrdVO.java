...
public class OrdVO implements Serializable{
	...
	private List<OrdFooditemVO> ordFooditemVOList;//改
	...
	//改
	public List<OrdFooditemVO> getOrdFooditemVOList(){return ordFooditemVOList;}
	
	public void setOrdFooditemVOList(List<OrdFooditemVO> ordFooditemVOList){ this.ordFooditemVOList=ordFooditemVOList;}
