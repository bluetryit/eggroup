...
<script>
		...
		webSocket.onmessage = function(event) {
	        ...
	        if(jsonObj.messageType=="text"){
	        	if(jsonObj.receiver==user){
	        		message =  "<div class='col'><div  class='right'>"+jsonObj.content + ": "+jsonObj.receiver+"</div></div><br>";
	        	}else{
	        		message =  "<div class='col'><div  class='left'>"+jsonObj.content + ": "+jsonObj.receiver+"</div></div><br>";
	        	}	        	
	...
	function sendMessage() {
	    ...
	    if (message === ""){
	        ...
	        var message ="<div class='col'><div class='right'>"+ message +":${sessionScope.memberVO.mem_name}</div></div><br>";
	        //allmessage+=message;
	        document.getElementById("messagesArea").innerHTML +=message;
 	        messagesArea.scrollTop = messagesArea.scrollHeight;
	    }
