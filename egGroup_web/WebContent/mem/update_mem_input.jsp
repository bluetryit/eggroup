...
<table>
	<tr>
		...
		<td><input type="TEXT" name="mem_no" size="45" 
			 value="<%= (memVO==null)? "吳永志" : memVO.getMem_no()%>" /></td>
	</tr>
	<tr>
		<td>會員姓名:</td>
	...
	<tr>
		<td>照片:</td>
		<td><input type="TEXT" name="mem_img" size="45"
			 value="<%= (memVO==null)? "100" : memVO.getMem_img()%>" /></td>
	</tr>
	<tr>
		<td>密碼:</td>
...
<input type="hidden" name="memno" value="<%=memVO.getMem_no()%>">
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=memVO.getMem_bd()%>', // value:   new Date(),
